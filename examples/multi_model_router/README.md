...
Route queries to the cheapest capable model using ForgentAI's learning/routing
...
The script uses ForgentAI's routing infrastructure from the learning pillar:
