"""ForgentSystem — the fully wired system dataclass."""
...
if TYPE_CHECKING:
    ...
    from forgent.channels._stubs import BaseChannel
    from forgent.learning._stubs import RouterPolicy
    ...
    from forgent.speech._stubs import SpeechBackend
...
class ForgentSystem:
    ...
    def wire_channel(self, channel_bridge: Any) -> None:
        ...
        ----------
        channel_bridge:
            A connected :class:`~forgent.channels._stubs.BaseChannel`
            instance whose ``on_message`` method accepts a callable.
        """
        from forgent.core.types import Message
        from forgent.sessions.session import SessionStore
    ...
    def __enter__(self) -> ForgentSystem:
        return self
