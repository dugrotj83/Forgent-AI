...
Routes incoming :class:`~forgent.channels._stubs.ChannelMessage` objects
...
from forgent.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in ForgentAI:\nforgent://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~forgent.agents._stubs.BaseAgent`
        subclass).
    max_workers:
