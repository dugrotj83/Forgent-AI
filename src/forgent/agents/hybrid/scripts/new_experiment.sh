...
# src/forgent/agents/hybrid/registry/<method>.toml
...
#
# Then run:
#   python -m forgent.agents.hybrid.runner --cell <printed name>
...
echo "Run with: python -m forgent.agents.hybrid.runner --cell ${name}"
