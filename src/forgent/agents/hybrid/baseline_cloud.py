...
matrix (see ``.forgent/experiments/hybrid/docs/results-table.md``).
...
from forgent.agents.hybrid._prices import cost as estimate_cost
from forgent.agents.hybrid._prices import default_max_output_tokens
