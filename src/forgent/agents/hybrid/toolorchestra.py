...
# Map the orchestrator's `model` slot to a concrete ForgentAI worker spec.
...
def _call_tavily_search(
    ...
    Token counts are reported as zero (no LLM was billed); the ForgentAI
...
_MODAL_APP_NAME = "forgent-toolorchestra-sandbox"
