...
scope for the ForgentAI port (and was out of scope in the hybrid harness).
...
from forgent.agents.hybrid._base import LocalCloudAgent
from forgent.agents.hybrid._prices import supports_temperature
