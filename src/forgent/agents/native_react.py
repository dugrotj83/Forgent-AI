...
Renamed from ``ReActAgent`` to clarify this is ForgentAI's native
...
from forgent.core.types import Message, Role, ToolCall, ToolResult, _message_to_dict
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        if self._skill_few_shot_examples:
            ...
            skill_examples_block = ""
        # Respect $FORGENT_HOME override for the base template (M2+ work).
        prompt_template = (
