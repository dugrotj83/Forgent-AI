...
called from your app startup:
    ...
    from forgent.agents.proactive_agent import register_cron
...
from forgent.tools.approval_store import (
...
from forgent.tools.proactive_tools import get_store
...
def _build_notification_channel(channel_spec: str) -> Optional[Any]:
    ...
    if channel_type == "imessage":
        from forgent.channels._stubs import (
            BaseChannel,
            ChannelStatus,
        )
        ...
        class _IMessageShim(BaseChannel):
            ...
            def send(
                ...
                from forgent.channels.imessage_daemon import send_imessage
...
class ProactiveAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        from forgent.tools.proactive_tools import (
            CheckPermissionTool,
