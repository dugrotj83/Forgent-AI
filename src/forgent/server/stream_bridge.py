...
from forgent.agents._stubs import AgentContext, BaseAgent
from forgent.core.events import Event, EventBus, EventType
from forgent.engine._base import looks_like_context_length_error
    ...
    async def stream(self) -> AsyncGenerator[str, None]:
        ...
        try:
            ...
            try:
                ...
                logger = logging.getLogger("forgent.server")
            ...
            if engine is not None and hasattr(engine, "stream_full") and content:
                ...
                try:
                    from forgent.core.types import Message as MsgType
                    from forgent.core.types import Role as RoleType
                    ...
                    _logger = _logging.getLogger("forgent.server")
                    _logger.warning(
