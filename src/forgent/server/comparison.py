...
<title>ForgentAI — Cost Comparison</title>
<style>
...
<div class="header">
  <h1><span>ForgentAI</span> Cost Comparison</h1>
  <div class="nav">
...
<div class="container">
  ...
  <div class="hero">
    ...
    <div class="sub">
      ForgentAI runs models on your own hardware. Every inference call that would
  ...
  <div class="calc-section">
    ...
    <div class="calc-results">
      <div class="calc-card free">
        <div class="cc-label">ForgentAI</div>
  ...
  <div class="cta">
    ...
    <div class="cta-sub">Install ForgentAI and run AI locally
      with zero API costs.</div>
    <div class="code-block">
      <code>git clone https://github.com/dugrotj83/Forgent-AI.git
&& cd Forgent-AI && uv sync</code>
...
document.getElementById('copy-btn').addEventListener('click', () => {
  const cmd = 'git clone https://github.com/dugrotj83/'
    + 'ForgentAI.git && cd Forgent-AI && uv sync';
