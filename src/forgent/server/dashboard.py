...
<title>ForgentAI — Savings Dashboard</title>
<style>
...
<div class="header">
  <h1><span>ForgentAI</span> Savings Dashboard</h1>
  <div class="status">
    <div class="dot"></div>
...
<div class="container">
  ...
  <div class="providers">
    <div class="provider-card openai">
      ...
      <div class="savings-amount green" id="prfg-openai">$0.00</div>
      <div class="sub">per month at current rate</div>
    </div>
    <div class="provider-card anthropic">
      <div class="pname">vs Anthropic</div>
      <div class="pmodel">projected monthly savings</div>
      <div class="savings-amount green" id="prfg-anthropic">$0.00</div>
      <div class="sub">per month at current rate</div>
    </div>
    <div class="provider-card google">
      <div class="pname">vs Google</div>
      <div class="pmodel">projected monthly savings</div>
      <div class="savings-amount green" id="prfg-google">$0.00</div>
      <div class="sub">per month at current rate</div>
    </div>
  </div>
...
async function refresh() {
  try {
    ...
    document.getElementById('prfg-openai')
      .textContent = fmtDollar(proj['gpt-5.3'] || 0);
    document.getElementById('prfg-anthropic')
      .textContent = fmtDollar(proj['claude-opus-4.6'] || 0);
    document.getElementById('prfg-google')
