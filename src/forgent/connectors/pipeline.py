...
from forgent.connectors._stubs import Attachment, Document
from forgent.connectors.chunker import SemanticChunker
...
if TYPE_CHECKING:
    from forgent.connectors.attachment_store import AttachmentStore
