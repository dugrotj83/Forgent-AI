...
Single source of truth for every event name and property the ForgentAI
...
see :mod:`forgent.analytics.redaction` for the value-level filters.
...
_SPECS: tuple[EventSpec, ...] = (
    ...
    EventSpec(
        ...
        description="`forgent init` finished and config.toml was written.",
        properties={
