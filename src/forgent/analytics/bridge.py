...
The internal bus (:mod:`forgent.core.events`) carries dozens of
...
from forgent.analytics.redaction import hash_id
from forgent.core.events import Event, EventType
    ...
    def _on_tool_end(self, event: Event) -> None:
        try:
            ...
            if first:
                ...
                from forgent.analytics.events import KNOWN_TOOL_NAMES
