...
from forgent.engine._base import (
    EngineConnectionError,
    InferenceEngine,
    estimate_prompt_tokens,
    messages_to_dicts,
)
from forgent.engine._http_async import (
...
def _default_num_ctx() -> int:
    """Default context window (tokens). Override with ``FORGENT_NUM_CTX``.
    ...
    """
    try:
        return int(os.environ.get("FORGENT_NUM_CTX", "16384"))
    except ValueError:
        return 16384
    ...
    def generate(
        ...
        **kwargs: Any,
        ...
        if response_format is not None:
            from forgent.engine._stubs import ResponseFormat
