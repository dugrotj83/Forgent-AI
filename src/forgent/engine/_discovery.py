...
def _make_engine(key: str, config: ForgentConfig) -> InferenceEngine:
...
def _maybe_register_mining_sidecar_engine() -> None:
    ...
    from forgent.engine._openai_compat import _OpenAICompatibleEngine
...
def discover_engines(config: ForgentConfig) -> List[Tuple[str, InferenceEngine]]:
