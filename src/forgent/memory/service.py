...
never blocks ``forgent serve`` request handling or the ``forgent chat`` REPL.
...
The service is started and stopped as part of the ForgentAI lifecycle (see
...
from forgent.memory.store import Fact, FactStore, create_fact_store
