...
Recipes are the universal composition format for ForgentAI.  Each recipe
...
class Recipe:
    ...
    def to_builder_kwargs(self) -> Dict[str, Any]:
        """Convert recipe fields to kwargs for SystemBuilder/Forgent.

        Returns a dict with only the non-None fields, keyed to match
        the SystemBuilder fluent API or Forgent constructor parameters.
        """
        kwargs: Dict[str, Any] = {}
    ...
    def to_eval_suite(
        ...
        """
        from forgent.recipes.composer import recipe_to_eval_suite
    ...
    def to_operator_manifest(self) -> Any:
        ...
        from forgent.recipes.composer import recipe_to_operator
...
def discover_recipes(
    ...
    *,
    ...
    3. User ``~/.forgent/recipes/`` directory
    4. User ``~/.forgent/operators/`` directory
