...
if TYPE_CHECKING:
    from forgent.evals.core.types import EvalSuiteConfig
    from forgent.operators.types import OperatorManifest
    from forgent.recipes.loader import Recipe
...
def recipe_to_eval_suite(
    ...
    backend = recipe.eval_backend or ("forgent-agent" if has_agent else "forgent-direct")
