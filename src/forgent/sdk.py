"""High-level Python SDK for ForgentAI."""
...
from forgent.system import ForgentSystem, SystemBuilder
...
class MemoryHandle:
    ...
    def __init__(self, config: ForgentConfig) -> None:
        self._config = config
    ...
    def _get_backend(self) -> Any:
        ...
        if not MemoryRegistry.contains(key):
            ...
            try:
                from forgent.tools.storage.sqlite import SQLiteMemory  # noqa: F401
            except ImportError:
                pass
    ...
    def index(
        ...
        *,
        ...
        from forgent.tools.storage.chunking import ChunkConfig
...
class Forgent:
    ...
    @property
    def config(self) -> ForgentConfig:
        """Return the active configuration."""
        return self._config

    @property
    def version(self) -> str:
        """Return the ForgentAI version string."""
        return forgent.__version__
    ...
    def _ensure_engine(self) -> None:
        ...
        try:
            import forgent.engine  # noqa: F401
        except ImportError:
            pass
    ...
    def _run_agent(
        ...
        *,
        ...
        if tools:
            ...
            from forgent.cli.ask import _build_tools
        ...
        if agent_name == "morning_digest" and hasattr(self._config, "digest"):
            ...
            from forgent.tools.digest_collect import DigestCollectTool
            from forgent.tools.text_to_speech import TextToSpeechTool
        ...
        if context and self._config.agent.context_from_memory:
            try:
                from forgent.cli.ask import _get_memory_backend
...
__all__ = ["Forgent", "ForgentSystem", "MemoryHandle", "SystemBuilder"]
