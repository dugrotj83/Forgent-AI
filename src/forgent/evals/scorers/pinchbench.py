...
Provides transcript translation (ForgentAI events → PinchBench format),
...
from forgent.evals.core.event_recorder import EventType
from forgent.evals.core.scorer import LLMJudgeScorer
from forgent.evals.core.types import EvalRecord

LOGGER = logging.getLogger(__name__)

# ---------------------------------------------------------------------------
# Tool name mapping: ForgentAI name → PinchBench-expected name
# ---------------------------------------------------------------------------
...
def _tool_results_to_transcript(
    ...
    """Build transcript from ForgentAgentBackend tool_results list."""
    transcript: List[Dict[str, Any]] = []
