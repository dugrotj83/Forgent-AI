...
def create_energy_monitor(
    ...
    try:
        from forgent.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from forgent.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from forgent.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from forgent.telemetry.energy_rapl import RaplEnergyMonitor
