...
from forgent.core.types import TOKEN_COUNTING_VERSION, Message, TelemetryRecord
from forgent.engine._stubs import InferenceEngine, StreamChunk
from forgent.telemetry.gpu_monitor import GpuSample
...
class InstrumentedEngine(InferenceEngine):
    ...
    :class:`~forgent.telemetry.energy_monitor.EnergyMonitor`), it is
