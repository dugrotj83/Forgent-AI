"""``forgent model`` — model management subcommands."""
...
from forgent.core.registry import ModelRegistry
from forgent.engine import discover_engines, discover_models
from forgent.intelligence import merge_discovered_models, register_builtin_models
