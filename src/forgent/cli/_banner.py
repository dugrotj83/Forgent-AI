"""Startup banner — Forgent AI wordmark + tagline."""

from __future__ import annotations

# "Forgent AI" rendered in the figlet "standard" font. Stored as plain text
...
def print_banner(quiet: bool = False) -> None:
    """Print the Forgent AI startup banner. No-op when quiet."""
    if quiet:
        return
    try:
