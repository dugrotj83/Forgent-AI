"""Global logging configuration for the Forgent AI CLI."""
...
from forgent.security.credential_stripper import CredentialStripper
...
def setup_logging(
    ...
    Returns
    -------
    The configured ``forgent`` logger.
    """
    logger = logging.getLogger("forgent")
