"""``forgent chat`` — interactive multi-turn chat REPL."""
...
def chat(
    ...
    # Resolve engine
    from forgent.engine import get_engine
    from forgent.intelligence import register_builtin_models
    ...
    if not model:
        from forgent.engine import discover_engines, discover_models
    ...
    if agent_key and agent_key != "none":
        try:
            import forgent.agents  # noqa: F401 — trigger registration
    ...
    # Print banner
    console.print(
        f"[green bold]Forgent AI Chat[/green bold]\n"
    ...
    from forgent.cli._bg_state import get_status
    from forgent.cli._chat_banner import render_startup_banner
    ...
    from forgent.cli._chat_notifications import NotificationDispatcher
