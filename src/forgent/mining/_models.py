...
from forgent.mining._constants import DEFAULT_PEARL_MODEL
...
class PearlModelSpec:
    """ForgentAI support metadata for a Pearl-compatible model."""
...
PEARL_MODEL_SPECS: tuple[PearlModelSpec, ...] = (
    ...
    PearlModelSpec(
        ...
        notes=(
            ...
            "ForgentAI before mining is enabled by default."
        ),
    ),
    PearlModelSpec(
