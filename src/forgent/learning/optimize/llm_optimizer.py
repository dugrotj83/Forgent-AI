"""LLM-based optimizer for ForgentAI configuration tuning.

Uses a cloud LLM to propose optimal ForgentAI configs, inspired by DSPy's
...
from forgent.core.types import Trace
from forgent.evals.core.backend import InferenceBackend
from forgent.evals.core.types import RunSummary
from forgent.learning.optimize.types import (
    BenchmarkScore,
    SampleScore,
    SearchSpace,
    TrialConfig,
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal ForgentAI configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an ForgentAI AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this ForgentAI evaluation result.")
        lines.append("")
