...
``~/.forgent/learning/skills/<skill-name>/optimized.toml``.
...
from forgent.core.types import Trace, TraceStep
...
class SkillOptimizer:
    ...
    def _run_dspy(
        ...
        """
        from forgent.core.config import DSPyOptimizerConfig
        from forgent.learning.agents.dspy_optimizer import DSPyAgentOptimizer
    ...
    def _run_gepa(
        ...
        from forgent.learning.agents.gepa_optimizer import GEPAAgentOptimizer
