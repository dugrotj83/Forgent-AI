...
Adapted from IPW's ``environment.py``.  Uses ForgentAI's
:class:`~forgent.tools._stubs.ToolExecutor` for real tool dispatch
...
class OrchestratorEnvironment:
    """RL environment that executes tools via ForgentAI ``ToolExecutor``.
