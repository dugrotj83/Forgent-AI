...
from forgent.learning.spec_search.diagnose.runner import DiagnosisRunner
from forgent.learning.spec_search.execute.base import ApplyContext
from forgent.learning.spec_search.execute.loop import _build_registry
from forgent.learning.spec_search.gate.benchmark_gate import BenchmarkGate
from forgent.learning.spec_search.gate.cold_start import check_readiness
...
from forgent.learning.spec_search.pending_queue import PendingQueue
from forgent.learning.spec_search.plan.planner import LearningPlanner
...
class SpecSearchOrchestrator:
    ...
    def from_config(
        ...
        *,
        ...
        See ``configs/forgent/examples/spec-search-quickstart.toml`` for
        the TOML schema and ``examples/forgent/spec_search_quickstart.py``
