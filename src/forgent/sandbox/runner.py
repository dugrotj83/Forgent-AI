...
_OUTPUT_START = "---FORGENT_OUTPUT_START---"
_OUTPUT_END = "---FORGENT_OUTPUT_END---"
...
class ContainerRunner:
    ...
    ----------
    image:
        Docker image to run.  Defaults to ``forgent-sandbox:latest``.
    timeout:
    ...
    DEFAULT_IMAGE = "forgent-sandbox:latest"
    DEFAULT_TIMEOUT = 300
    ...
    def _load_allowlist(self):
        ...
        if not self._mount_allowlist_path:
            from forgent.sandbox.mount_security import (
                MountAllowlist,
            )
    ...
    def run(
        ...
        *,
        ...
        container_name = f"fg-sandbox-{uuid.uuid4().hex[:12]}"
