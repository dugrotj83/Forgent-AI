...
if TYPE_CHECKING:
    from forgent.core.types import ToolSpec  # noqa: F401
...
def load_mcp_tools_from_config(
    ...
    *,
    ...
    """
    # ``enabled`` and ``servers`` come from forgent.core.config's
    ...
    # Imported lazily so that `forgent.mcp.loader` can be imported
