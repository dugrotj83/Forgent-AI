...
class TestDetectHardware:
    ...
    @patch("forgent.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "forgent.core.config._run_cmd",
    ...
    @patch("forgent.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "forgent.core.config._run_cmd",
        side_effect=[
    ...
    @patch("forgent.core.config.platform.system", return_value="Darwin")
    @patch(
        "forgent.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("forgent.core.config.shutil.which", return_value=None)
    @patch("forgent.core.config.platform.system", return_value="Linux")
