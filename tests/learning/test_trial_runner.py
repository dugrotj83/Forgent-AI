"""Tests for forgent.optimize.trial_runner module."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from forgent.evals.core.types import RunConfig, RunSummary
from forgent.learning.optimize.trial_runner import TrialRunner
from forgent.learning.optimize.types import TrialConfig, TrialResult
...
class TestBuildRunConfig:
    ...
    def test_agent_maps_to_agent_backend(self) -> None:
        ...
        assert cfg.backend == "forgent-agent"
    ...
    def test_no_agent_maps_to_direct_backend(self) -> None:
        ...
        assert cfg.backend == "forgent-direct"
...
class TestRunTrial:
    ...
    @patch("forgent.evals.cli._build_scorer")
    @patch("forgent.evals.cli._build_judge_backend")
    @patch("forgent.evals.cli._build_dataset")
    @patch("forgent.evals.cli._build_backend")
    @patch("forgent.evals.core.runner.EvalRunner")
    ...
    def test_run_trial_populates_sample_scores(
        ...
        from forgent.evals.core.types import EvalResult
