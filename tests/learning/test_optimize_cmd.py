"""Smoke tests for ``forgent optimize`` and ``forgent feedback`` CLI commands,
...
class TestOptimizeConfig:
    """Tests for OptimizeConfig in ForgentConfig."""

    def test_optimize_config_in_forgent_config(self):
        from forgent.core.config import ForgentConfig, OptimizeConfig
    ...
    def test_optimize_config_defaults(self):
        from forgent.core.config import OptimizeConfig
