...
class TestGRPOConfig:
    def test_default_config(self) -> None:
        from forgent.core.config import GRPOConfig
...
class TestDefaultRewardFn:
    def test_score_returns_float(self) -> None:
        from forgent.learning.intelligence.grpo_trainer import DefaultRewardFn
...
class TestGRPOTrainer:
    def test_init(self) -> None:
        from forgent.core.config import GRPOConfig
        from forgent.learning.intelligence.grpo_trainer import GRPOTrainer
