...
class TestSystemBuilder:
    ...
    def test_import_works(self):
        ...
        assert ForgentSystem is not None
    ...
    def test_builder_default_config(self):
        ...
        assert isinstance(builder._config, ForgentConfig)
...
class TestSystemBuilderEngineInstance:
    """Explicit engine injection (forgent eval --base-url path)."""
    ...
    def test_engine_instance_is_fluent(self):
        builder = SystemBuilder(ForgentConfig())
    ...
    def test_unhealthy_injected_instance_never_consults_discovery(self):
        ...
        with patch("forgent.engine._discovery.get_engine") as mock_get_engine:
