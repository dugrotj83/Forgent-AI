"""Tests for the persistent fact store (forgent.memory.store)."""
...
from forgent.core.registry import FactStoreRegistry
from forgent.memory.store import LocalFactStore, create_fact_store
...
def test_create_fact_store_default_path_uses_forgent_home(tmp_path, monkeypatch):
    monkeypatch.setenv("FORGENT_HOME", str(tmp_path))
