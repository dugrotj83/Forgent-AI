...
class TestOpenHandsPipeline:
    ...
    def test_openhands_code_execution_e2e(self):
        _register_all()
        from forgent.agents.native_openhands import NativeOpenHandsAgent
        from forgent.tools.code_interpreter import (
            CodeInterpreterTool,
        )
...
class TestMCPIntegration:
    ...
    def test_mcp_server_with_all_tools(self):
        ...
        from forgent.mcp.transport import InProcessTransport
        from forgent.tools.calculator import CalculatorTool
        from forgent.tools.think import ThinkTool
    ...
    def test_mcp_unknown_tool_error(self):
        from forgent.mcp.client import MCPClient
        from forgent.mcp.protocol import MCPError
        from forgent.mcp.server import MCPServer
        from forgent.mcp.transport import InProcessTransport
        from forgent.tools.calculator import CalculatorTool
...
class TestModelCatalogIntegration:
    ...
    def test_all_models_routable(self):
        ...
        from forgent.intelligence.model_catalog import (
            BUILTIN_MODELS,
        )
