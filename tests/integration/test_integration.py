...
from forgent.core.registry import AgentRegistry, RouterPolicyRegistry, ToolRegistry
...
class TestHeuristicRewardWithTelemetry:
    ...
    def test_reward_from_telemetry_record(self):
        from forgent.learning._stubs import RoutingContext
...
class TestRouterPolicyRegistryDiscovery:
    ...
    def test_both_policies_registered(self):
        from forgent.learning import ensure_registered
...
class TestAskFlowWithRouterPolicy:
    ...
    def test_mocked_ask_with_registry_router(self):
        from forgent.learning._stubs import RoutingContext
        from forgent.learning.routing.heuristic_policy import ensure_registered
...
class TestSDKImport:
    """Verify Forgent class is importable from forgent."""

    def test_forgent_imports(self):
        from forgent import Forgent

        assert Forgent is not None
...
class TestSDKAskFlow:
    ...
    def test_sdk_ask_e2e(self):
        ...
        from forgent.sdk import Forgent
...
class TestSDKMemoryHandle:
    ...
    def test_index_and_search(self, tmp_path):
        from forgent.core.config import ForgentConfig
        from forgent.sdk import MemoryHandle
...
class TestBenchmarkRegistryDiscovery:
    ...
    def test_discovers_benchmarks(self):
        from forgent.bench import ensure_registered
...
class TestBenchmarkSuiteRunAll:
    ...
    def test_suite_produces_jsonl(self):
        ...
        from forgent.bench import ensure_registered
        from forgent.bench._stubs import BenchmarkSuite
        from forgent.core.registry import BenchmarkRegistry
...
class TestFullPipeline:
    ...
    def test_full_pipeline(self, tmp_path):
        ...
        with patch("forgent.sdk.get_engine", return_value=("mock", engine)):
            j = Forgent(config=cfg, model="test-model")
