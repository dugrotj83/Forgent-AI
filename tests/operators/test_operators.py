...
class TestOperativeAgent:
    def test_init_defaults(self):
        ...
        engine = FakeEngine()
        with patch(
            "forgent.agents._stubs.load_config",
...
class TestSystemAskPassthrough:
    def test_system_prompt_forwarded(self):
        ...
        from forgent.system import QueryOrchestrator

        with patch.object(QueryOrchestrator, "_run_agent", patched_run_agent):
            real_system = ForgentSystem(
...
class TestOperatorsConfig:
    def test_config_defaults(self):
        from forgent.core.config import OperatorsConfig
    ...
    def test_config_in_forgent_config(self):
        from forgent.core.config import ForgentConfig
...
class TestLoadBundledOperators:
    ...
    def operators_dir(self):
        ...
        ops_dir = project_root / "src" / "forgent" / "operators" / "data"
