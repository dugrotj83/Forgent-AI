...
from forgent.bench.energy import EnergyBenchmark
from forgent.core.registry import BenchmarkRegistry
from forgent.telemetry.energy_monitor import EnergySample


@pytest.fixture(autouse=True)
def _register_energy():
    """Re-register energy benchmark after registry clear."""
    from forgent.bench.energy import ensure_registered
