...
PROVIDERS = [
    ("forgent.evals.datasets.adp", "ADPDataset"),
    ("forgent.evals.datasets.toolorchestra", "ToolOrchestraDataset"),
    ("forgent.evals.datasets.generalthoughts", "GeneralThoughtsDataset"),
]
