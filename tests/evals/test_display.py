"""Tests for the Rich display helpers in forgent.evals.core.display."""
...
from forgent.evals.core.types import MetricStats, RunSummary
...
class TestPrintBanner:
    def test_produces_output(self):
        ...
        output = buf.getvalue()
        assert "ForgentAI" in output or "___" in output
