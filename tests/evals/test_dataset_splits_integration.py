...
PROVIDERS = [
    ("forgent.evals.datasets.pinchbench", "PinchBenchDataset"),
    ("forgent.evals.datasets.liveresearch", "LiveResearchBenchDataset"),
    ("forgent.evals.datasets.gaia", "GAIADataset"),
    ("forgent.evals.datasets.liveresearchbench", "LiveResearchBenchDataset"),
    ("forgent.evals.datasets.taubench", "TauBenchDataset"),
    ("forgent.evals.datasets.toolcall15", "ToolCall15Dataset"),
    ("forgent.evals.datasets.livecodebench", "LiveCodeBenchDataset"),
]
