...
from forgent.evals.core.event_recorder import AgentEvent, EventType
from forgent.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from forgent.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """ForgentAI tool names are mapped to PinchBench-expected names."""
    from forgent.evals.scorers.pinchbench import events_to_transcript
