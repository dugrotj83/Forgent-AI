"""Verify ForgentAgentBackend.generate_full returns the spec §6.2 extended fields."""
...
class TestForgentAgentExtendedFields:
    def test_generate_full_includes_framework_and_commit(self) -> None:
        ...
        with patch("forgent.system.SystemBuilder") as MockSB:
            ...
            backend = ForgentAgentBackend(model="qwen-9b")
