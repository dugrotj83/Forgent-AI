"""Tests for ForgentAgentBackend skills_enabled / overlay_dir kwargs (Plan 2B)."""
...
class TestForgentAgentBackendSkillsKwargs:
    ...
    def test_init_signature_accepts_kwargs_without_engine(self):
        ...
        sig = inspect.signature(ForgentAgentBackend.__init__)
