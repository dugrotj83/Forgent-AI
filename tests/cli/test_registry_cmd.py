"""Tests for the ``forgent registry`` CLI commands."""
...
class TestRegistryCmd:
    """Test cases for the forgent registry CLI group."""
    ...
    def test_registry_show_handles_exception(self) -> None:
        ...
        with patch(
            "forgent.core.registry.ToolRegistry.keys",
    ...
    def test_registry_show_handles_error_during_import(self) -> None:
        ...
        with patch.dict("sys.modules", {"forgent.core.registry": None}):
