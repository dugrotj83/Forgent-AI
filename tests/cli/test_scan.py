"""Tests for ``forgent scan`` privacy scanner CLI command."""
...
from forgent.cli.scan_cmd import PrivacyScanner, ScanResult
...
class TestJsonOutput:
    ...
    def test_json_output_structure(self) -> None:
        ...
        runner = CliRunner()
        with patch(
            "forgent.cli.scan_cmd.PrivacyScanner.run_all",
            return_value=[
