"""Tests for model resolution fallback chain in forgent ask."""
...
def _register_agents():
    ...
    The default ``ForgentConfig().agent.default_agent`` is ``"simple"``,
    so ``forgent ask "..."`` (without ``--agent``) routes through SimpleAgent.
