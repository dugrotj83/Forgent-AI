"""Tests for context injection integration in ``forgent ask``."""
...
def test_get_memory_backend_returns_backend_even_when_empty(
    ...
    failures downstream.
    """
    from forgent.core.config import ForgentConfig, MemoryConfig
    ...
    mod = importlib.import_module("forgent.cli.ask")
