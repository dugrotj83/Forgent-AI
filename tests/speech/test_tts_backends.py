...
from forgent.core.registry import TTSRegistry
from forgent.speech.tts import TTSResult
...
def test_cartesia_registered():
    from forgent.speech.cartesia_tts import CartesiaTTSBackend
...
def test_cartesia_synthesize():
    ...
    with patch(
        "forgent.speech.cartesia_tts._cartesia_synthesize",
...
def test_kokoro_registered():
    from forgent.speech.kokoro_tts import KokoroTTSBackend
...
def test_openai_tts_registered():
    from forgent.speech.openai_tts import OpenAITTSBackend
...
def test_openai_tts_synthesize():
    ...
    with patch(
        "forgent.speech.openai_tts._openai_tts_request",
