...
from forgent.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("forgent.speech.deepgram.DeepgramClient", return_value=mock_client):
        from forgent.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("forgent.speech.deepgram.DeepgramClient"):
        from forgent.speech.deepgram import DeepgramSpeechBackend
