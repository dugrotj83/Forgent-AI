...
from forgent.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_transcribe():
    ...
    with patch("forgent.speech.openai_whisper.OpenAI", return_value=mock_client):
        from forgent.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_health():
    with patch("forgent.speech.openai_whisper.OpenAI"):
        from forgent.speech.openai_whisper import OpenAIWhisperBackend
