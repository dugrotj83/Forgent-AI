...
from forgent.core import get_python_executable
from forgent.tools.shell_exec import ShellExecTool
...
class TestShellExecTool:
    def test_registered_via_tools_package_import(self):
        import forgent.tools as tools_pkg
        from forgent.core.registry import ToolRegistry

        sys.modules.pop("forgent.tools.shell_exec", None)
    ...
    def test_env_clearing(self):
        ...
        marker = "FORGENT_TEST_SECRET_12345"
    ...
    def test_env_passthrough(self):
        ...
        marker = "FORGENT_TEST_PASSTHROUGH_67890"
