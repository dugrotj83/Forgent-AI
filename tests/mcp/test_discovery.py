...
_PATCH_HTTP = "forgent.mcp.transport.StreamableHTTPTransport"
_PATCH_STDIO = "forgent.mcp.transport.StdioTransport"
_PATCH_CLIENT = "forgent.mcp.client.MCPClient"
_PATCH_PROVIDER = "forgent.tools.mcp_adapter.MCPToolProvider"
_PATCH_LOGGER = "forgent.system.builder.logger"
