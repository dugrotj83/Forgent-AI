...
def test_returns_tools_from_mcp_server(mock_load_config: MagicMock):
    ...
    with (
        patch("forgent.mcp.transport.StreamableHTTPTransport"),
        patch("forgent.mcp.client.MCPClient"),
