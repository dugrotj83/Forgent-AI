...
from forgent.core.events import EventBus, EventType  # noqa: E402
from forgent.server.app import create_app  # noqa: E402
...
class TestChatCompletions:
    ...
    def test_instrumented_engine_unwrapped_to_avoid_dual_telemetry(self):
        ...
        from forgent.core.types import TOKEN_COUNTING_VERSION
    ...
    def test_streaming_with_tools_emits_tool_calls_and_bypasses_agent(self):
        ...
        from forgent.engine._stubs import StreamChunk
...
def _identity_config():
    ...
    cfg = ForgentConfig()
    cfg.agent.default_system_prompt = "You are ForgentAI."
    cfg.analytics.enabled = False
    return cfg
...
class TestIdentityPromptInjection:
    ...
    saw ForgentAI's identity system prompt and the model answered from its
    ...
    def test_stream_injects_identity_when_absent(self):
        ...
        assert "ForgentAI" in msgs[0].content
...
def _traces_enabled_config(tmp_path):
    ...
    tests fail on any machine whose ``~/.forgent/config.toml`` disables
