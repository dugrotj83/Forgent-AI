...
from forgent.core.types import Role  # noqa: E402
from forgent.server.agent_manager_routes import (  # noqa: E402
...
class TestBuildManagedSystemPrompt:
    ...
    def _config_with_soul(self, tmp_path):
        ...
        soul.write_text("You are Forgent, a meticulous local-first assistant.")
    ...
    def test_matches_cli_builder_output(self, tmp_path):
        ...
        so streaming chat and `forgent ask` assemble the prompt identically.
        """
        from forgent.core.config import MemoryFilesConfig, SystemPromptConfig
