...
class TestDockerFiles:
    ...
    def test_dockerfiles_build_native_rust_extension(self):
        ...
        required_markers = [
            ...
            "rust/crates/forgent-python/Cargo.toml",
            "/tmp/forgent-rust-wheel/*.whl",
            "import forgent_rust",
        ]
    ...
    def test_systemd_service_exists(self):
        assert (SYSTEMD_DIR / "forgent.service").is_file()
...
class TestSystemdHardening:
    ...
    def _service(self) -> str:
        return (SYSTEMD_DIR / "forgent.service").read_text()
