"""Persona files reach persistent agents, not just one-shot `forgent ask` (#376).

SOUL.md / MEMORY.md / USER.md are loaded by `forgent ask` via SystemPromptBuilder.
...
from forgent.core.config import MemoryFilesConfig, SystemPromptConfig
