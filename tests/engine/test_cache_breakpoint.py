...
def test_anthropic_cache_breakpoint_added():
    from forgent.engine.cloud import _annotate_anthropic_cache

    messages = [
        {"role": "system", "content": "You are Forgent. ## Persona\nHelpful assistant."},
...
def test_already_list_content_gets_cache_control():
    ...
    messages = [
        {"role": "system", "content": [{"type": "text", "text": "You are Forgent."}]},
    ]
    annotated = _annotate_anthropic_cache(messages)
