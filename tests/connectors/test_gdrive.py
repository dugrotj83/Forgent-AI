...
def connector(tmp_path: Path):
    ...
    from forgent.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("forgent.connectors.gdrive._gdrive_api_list_files")
@patch("forgent.connectors.gdrive._gdrive_api_export")
