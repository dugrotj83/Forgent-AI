...
class TestOuraLive:
    def test_sync_returns_documents(self):
        from forgent.connectors.oura import OuraConnector
...
class TestStravaLive:
    def test_sync_returns_documents(self):
        from forgent.connectors.strava import StravaConnector
...
class TestSpotifyLive:
    def test_sync_returns_documents(self):
        from forgent.connectors.spotify import SpotifyConnector
...
class TestGoogleTasksLive:
    def test_sync_returns_documents(self):
        from forgent.connectors.google_tasks import GoogleTasksConnector
