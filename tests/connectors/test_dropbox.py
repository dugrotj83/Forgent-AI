...
def connector(tmp_path: Path):
    ...
    from forgent.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("forgent.connectors.dropbox._dropbox_api_list_folder")
@patch("forgent.connectors.dropbox._dropbox_api_download")
