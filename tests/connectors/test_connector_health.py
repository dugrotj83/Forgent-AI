...
_LOCAL_CONNECTORS = [
    ("apple_notes", "forgent.connectors.apple_notes", "AppleNotesConnector"),
    ("imessage", "forgent.connectors.imessage", "IMessageConnector"),
]

_TOKEN_CONNECTORS = [
    ("gmail_imap", "forgent.connectors.gmail_imap", "GmailIMAPConnector"),
    ("outlook", "forgent.connectors.outlook", "OutlookConnector"),
    ("slack", "forgent.connectors.slack_connector", "SlackConnector"),
    ("notion", "forgent.connectors.notion", "NotionConnector"),
    ("granola", "forgent.connectors.granola", "GranolaConnector"),
    ("gdrive", "forgent.connectors.gdrive", "GDriveConnector"),
    ("gcalendar", "forgent.connectors.gcalendar", "GCalendarConnector"),
    ("gcontacts", "forgent.connectors.gcontacts", "GContactsConnector"),
    ("dropbox", "forgent.connectors.dropbox", "DropboxConnector"),
]
