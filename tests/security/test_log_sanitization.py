...
class TestSanitizingFormatter:
    ...
    def test_redacts_openai_key(self) -> None:
        from forgent.cli.log_config import SanitizingFormatter
        ...
        record = logging.LogRecord(
            ...
            pathname="",
            lineno=0,
            msg="Key is sk-prfg-abc123def456ghi789jkl012mno345pqr678stu",
            args=(),
            exc_info=None,
        )
...
class TestScopedCredentialAccess:
    ...
    def test_returns_credential_value(self) -> None:
        from forgent.core.credentials import get_tool_credential
