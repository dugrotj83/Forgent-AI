...
from forgent.core.config import CapabilitiesConfig, ForgentConfig, SecurityConfig
from forgent.core.events import EventBus
from forgent.security import SecurityContext, setup_security
...
def _make_config(*, enabled: bool = True, caps_enabled: bool = False) -> ForgentConfig:
    cfg = ForgentConfig()
