...
const OPTIN_KEY = 'forgent-desktop-optin';
const OPTIN_NAME_KEY = 'forgent-desktop-display-name';
const OPTIN_EMAIL_KEY = 'forgent-desktop-email';
const OPTIN_ANONID_KEY = 'forgent-desktop-anon-id';
    ...
    <div style={styles.container}>
      ...
      {showOptIn ? (
        ...
        <div style={{ marginBottom: 16, display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <a
            href="https://github.com/dugrotj83/Forgent-AI/leaderboard"
            target="_blank"
