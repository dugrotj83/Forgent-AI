...
const DISABLED_KEY = 'fg-auto-update-disabled';
...
export function UpdateChecker() {
  ...
  useEffect(() => {
    ...
    // VITE_FORGENT_NO_UPDATER=1`` before ``npm run tauri dev`` to
    // silence the 30-min poll. See docs/desktop-auto-update.md.
    const noUpdater = (import.meta as any).env?.VITE_FORGENT_NO_UPDATER;
