...
impl PyMessage {
    pub fn to_core(&self) -> forgent_core::Message {
        let role = match self.role.as_str() {
            "system" => forgent_core::Role::System,
            "assistant" => forgent_core::Role::Assistant,
            "tool" => forgent_core::Role::Tool,
            _ => forgent_core::Role::User,
        };
        forgent_core::Message {
            role,
...
#[pyclass(name = "Config")]
pub struct PyConfig {
    pub inner: forgent_core::ForgentConfig,
}
...
impl PyConfig {
    ...
    fn new() -> Self {
        Self {
            inner: forgent_core::ForgentConfig::default(),
        }
    }
...
pub struct PyEventBus {
    pub inner: std::sync::Arc<forgent_core::EventBus>,
}
...
impl PyEventBus {
    ...
    fn new() -> Self {
        Self {
            inner: std::sync::Arc::new(forgent_core::EventBus::new(true)),
        }
    }
