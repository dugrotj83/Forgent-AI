...
use forgent_core::{GenerateResult, Message, Role};
use serde_json::Value;
use std::pin::Pin;
use tokio_stream::Stream;

pub type StreamItem = Result<String, forgent_core::ForgentAIError>;
...
pub trait InferenceEngine: Send + Sync {
    ...
    fn generate(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<GenerateResult, forgent_core::ForgentAIError>;
    ...
    async fn stream(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<TokenStream, forgent_core::ForgentAIError>;

    fn list_models(&self) -> Result<Vec<String>, forgent_core::ForgentAIError>;
...
mod tests {
    use super::*;
    use forgent_core::{Message, ToolCall};
