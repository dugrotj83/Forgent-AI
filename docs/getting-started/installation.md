---
title: Installation
description: Get ForgentAI running — browser app, desktop app, CLI, or Python SDK
search:
  boost: 3
---
...
=== "Step 1: Clone and install"
    ...
    uv run maturin develop -m rust/crates/forgent-python/Cargo.toml
...
| Platform | Download |
|----------|----------|
| macOS (Universal) | [:material-download: **ForgentAI.dmg**](https://github.com/dugrotj83/Forgent-AI/releases/download/desktop-v1.0.2/ForgentAI_1.0.1_universal.dmg) |
| Windows (64-bit) | [:material-download: **ForgentAI-setup.exe**](https://github.com/dugrotj83/Forgent-AI/releases/download/desktop-v1.0.2/ForgentAI_1.0.1_x64-setup.exe) |
| Linux (DEB) | [:material-download: **ForgentAI.deb**](https://github.com/dugrotj83/Forgent-AI/releases/download/desktop-v1.0.2/ForgentAI_1.0.1_amd64.deb) |
| Linux (RPM) | [:material-download: **ForgentAI.rpm**](https://github.com/dugrotj83/Forgent-AI/releases/download/desktop-v1.0.2/ForgentAI-1.0.1-1.x86_64.rpm) |
| Linux (AppImage) | [:material-download: **ForgentAI.AppImage**](https://github.com/dugrotj83/Forgent-AI/releases/download/desktop-v1.0.2/ForgentAI_1.0.1_amd64.AppImage) |
...
ForgentAI uses optional extras to keep the base installation lightweight.
...
!!! note "Ollama, vLLM, and llama.cpp are HTTP-based"
    These engines have no additional Python dependencies — ForgentAI communicates over HTTP. You still need the engine software running on your machine.
...
| `server` | `uv sync --extra server` | OpenAI-compatible API server (`forgent serve`) |
...
ForgentAI requires at least one inference backend. Choose the one that matches your hardware.
