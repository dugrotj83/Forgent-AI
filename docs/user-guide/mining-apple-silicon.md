...
README. Then write ForgentAI' mining config:
...
```bash
forgent mine doctor        # capability matrix
forgent mine start         # launch gateway + miner-loop subprocesses
forgent mine status        # check sidecar + gateway metrics
forgent mine logs -n 120   # print recent logs
forgent mine stop          # stop mining subprocesses
```
