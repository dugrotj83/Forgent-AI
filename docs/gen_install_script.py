...
Serves the installers at::
    ...
    https://github.com/dugrotj83/Forgent-AI/install.sh   (Linux / macOS / WSL2)
    https://github.com/dugrotj83/Forgent-AI/install.ps1  (native Windows)

so users have an HTTPS-valid, project-controlled install URL that does not
depend on the externally-hosted ``forgent.ai`` domain — whose TLS config
