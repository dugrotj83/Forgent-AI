...
description: How to add your setup to the ForgentAI Showcase
---

# Contributing a Showcase Entry

The Showcase exists for one reason: to help a confused, curious, *non-technical* reader figure out whether ForgentAI is worth their weekend. That goal sets every editorial choice on this page.
...
→ **[Recipe: <name>](https://github.com/dugrotj83/Forgent-AI/tree/main/src/forgent/recipes/data)** if you want the exact config.
...
✅ "Forgent answers my Discord messages while I sleep."
...
Hannah and the docs team post merged showcase entries to **`#config-showcase`** in [the ForgentAI Discord](https://discord.gg/forgent). You'll get tagged in the post — you don't have to do it yourself.
