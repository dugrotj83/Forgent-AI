...
```python
from forgent.intelligence import merge_discovered_models
...
The following names are still importable from `forgent.intelligence` via shim modules, but their canonical locations have moved:
