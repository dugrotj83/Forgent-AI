#!/usr/bin/env python3
"""Index ForgentAI docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual ForgentAI docs the boilerplate that
    # crowds retrieval ("ForgentAI runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does forgent support?",
